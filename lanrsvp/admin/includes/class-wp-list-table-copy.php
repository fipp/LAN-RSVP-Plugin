 ...
 * The class is copied since the wordpress developers cannot guarantee that the class will stay the same.
 *
 * @package WordPress
...
class WP_List_Table_Copy {
	...
	function ajax_user_can() {
		die( 'function WP_List_Table_Copy::ajax_user_can() must be over-ridden in a sub-class.' );
	}
	...
	function prepare_items() {
		die( 'function WP_List_Table_Copy::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	function get_columns() {
		die( 'function WP_List_Table_Copy::get_columns() must be over-ridden in a sub-class.' );
	}
