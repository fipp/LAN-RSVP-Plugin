(function ( $ ) {
	...
	$(function () {
        ...
        $('form.lanrsvp-update-grid').find('input[type="range"]').change(function() {
            var form = $(this).parents('form');
            numberOfRows = form.find('input[name="rows-range"]').val();
            numberOfColumns = form.find('input[name="cols-range"]').val();
            form.find('input[name="cols-number"]').val(numberOfColumns);
            form.find('input[name="rows-number"]').val(numberOfRows);
        ...
        $('form.lanrsvp-update-grid').find('input[type="number"]').change(function() {
            var form = $(this).parents('form');
            numberOfRows = form.find('input[name="rows-number"]').val();
            numberOfColumns = form.find('input[name="cols-number"]').val();
            form.find('input[name="cols-range"]').val(numberOfColumns);
            form.find('input[name="rows-range"]').val(numberOfRows);
